...
public class staffadminregistration extends JFrame implements ActionListener, FocusListener {
	CheckboxGroup cbmf;
	Checkbox cbm, cbf;
	ResultSet rs = null;
	Statement stmt = null;
	...
	;
		...
		btnSave = new JButton("Save Staff Details");
		//pAdmin.add(btnSave).setBounds(0, 334, 65, 25);
		btnClear = new JButton("Clear Text");
		btnRefresh = new JButton("Refresh Page");
	...
	void visible(){
		...
		pAdmin.add(btnSave).setBounds(0, 334, 140, 25);
		pAdmin.add(btnRefresh).setBounds(150, 334, 120, 25);
		
		pAdmin.add(btnClear).setBounds(280, 334, 100, 25);
		pAdmin.add(btnExit).setBounds(390, 334, 75, 25);
		pAdmin.add(txtrAddress).setBounds(90, 224, 370, 100);
		pAdmin.add(txtpNumber).setBounds(90,158,230,20);
