...
class staffmanager_list extends JFrame implements ActionListener
{
	...
	staffmanager_list()
	{
		...
		JLabel l=new JLabel("<html><font size=6 color=#800080><i>Staffs/Manager List");
		...
		c.add("South",butpan);
			...
			DefaultTableModel model=new DefaultTableModel(new String[]{"Date ","Time ","Contributor's ID", "full name", "Phone Number","Position","Gender", "Email Address"},row);
			...
			while(set.next())
			{
				...
				model.setValueAt(set.getString(5).trim(),i,5);
